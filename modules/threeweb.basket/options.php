...
$module_id = 'threeweb.telegramchat'; //обязательно, иначе права доступа не работают!
...
$aTabs = array(
    array(
        ...
        'OPTIONS' => array(
            ...
            array('field_line', Loc::getMessage('PASS'),
                '',
                array('text', 20)),
            ),
    ),
...
?>
<? $tabControl->Begin(); ?>
<form method='post' action='<?echo $APPLICATION->GetCurPage()?>?mid=<?=htmlspecialcharsbx($request['mid'])?>&amp;lang=<?=$request['lang']?>' name='threeweb_telegramchat_settings'>
